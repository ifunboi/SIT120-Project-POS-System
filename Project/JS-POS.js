var products = {
  // (A) PRODUCTS LIST
  list : {
    1 : { name:"Banana", img:"banana.png", price: 120 },
    2 : { name:"Cherry", img:"cherry.png", price: 550 },
    3 : { name:"Ice Cream", img:"icecream.png", price: 85 },
    4 : { name:"Orange", img:"orange.png", price: 80 },
    5 : { name:"Strawberry", img:"strawberry.png", price: 120 },
    6 : { name:"Watermelon", img:"watermelon.png", price: 160 }
  },
  ...
  change : (pid, qty) => {
    ...
    // (H2) UPDATE TOTAL ONLY
      ...
      for (let id in cart.items) {
        ...
        document.getElementById("ctotal").innerHTML ="TOTAL: Rs." + total;
      }
    }
  },
...
var orders = {
  ...
  print : () => {
    ...
    for (let pid in cart.items) {
      ...
      item.innerHTML = `Rs.{cart.items[pid]} X Rs.{products.list[pid].name}`;
      wrapper.appendChild(item);
    }
